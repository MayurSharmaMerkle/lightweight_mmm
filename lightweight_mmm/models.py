...
#         fn=custom_priors.get("gamma_alpha", transform_default_priors["gamma_alpha"]), sample_shape=(num_samples,))
    
#     # Sample gamma_beta_sample
#     gamma_beta_sample = numpyro.sample(
#         name="gamma_beta_sample",
#         fn=custom_priors.get("gamma_beta", transform_default_priors["gamma_beta"]), sample_shape=(num_samples,))
    
#     # Sample exponent_sample
#     exponent_sample = numpyro.sample(
#         name="exponent_sample",
#         fn=custom_priors.get("exponent", transform_default_priors["exponent"]), sample_shape=(num_samples,))
    
#     # Calculate mean of samples for each channel separately
#     gamma_alpha = jnp.mean(gamma_alpha_sample, axis=0)
#     gamma_beta = jnp.mean(gamma_beta_sample, axis=0)
#     exponent = jnp.mean(exponent_sample, axis=0)
